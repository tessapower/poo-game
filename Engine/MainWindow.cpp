...
MainWindow::MainWindow(HINSTANCE hInst, wchar_t* lpCmdLine)
    : args(lpCmdLine), hInst(hInst) {
  ...
  WNDCLASSEX wc = {sizeof(WNDCLASSEX),
                   ...
                   wndClassName,
                   nullptr};
  wc.hIconSm = (HICON)LoadImage(hInst, MAKEINTRESOURCE(IDI_APPICON), IMAGE_ICON,
                                16, 16, 0);
  wc.hIcon = (HICON)LoadImage(hInst, MAKEINTRESOURCE(IDI_APPICON), IMAGE_ICON,
                              32, 32, 0);
  ...
  hWnd = CreateWindow(wndClassName, L"The Poo Game",
...
void MainWindow::ShowMessageBox(const std::wstring& title,
...
LRESULT WINAPI MainWindow::_HandleMsgSetup(HWND hWnd, UINT msg, WPARAM wParam,
                                           LPARAM lParam) {
...
LRESULT WINAPI MainWindow::_HandleMsgThunk(HWND hWnd, UINT msg, WPARAM wParam,
                                           LPARAM lParam) {
...
LRESULT MainWindow::HandleMsg(HWND hWnd, UINT msg, WPARAM wParam,
                              LPARAM lParam) {
  switch (msg) {
    case WM_DESTROY:
      PostQuitMessage(0);
