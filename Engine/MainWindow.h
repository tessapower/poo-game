...
class MainWindow : public HWNDKey {
 ...
 public:
  ...
  void ShowMessageBox(const std::wstring& title,
 ...
 private:
  static LRESULT WINAPI _HandleMsgSetup(HWND hWnd, UINT msg, WPARAM wParam,
                                        LPARAM lParam);
  static LRESULT WINAPI _HandleMsgThunk(HWND hWnd, UINT msg, WPARAM wParam,
                                        LPARAM lParam);
 ...
 private:
  static constexpr wchar_t const* wndClassName =
